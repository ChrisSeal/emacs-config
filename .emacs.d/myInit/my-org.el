...
(define-key org-agenda-mode-map "l" 'org-store-link)

(set-register ?o (cons 'file "~/Dropbox/OrgFiles/refile.org"))
;;(setq org-refile-targets (quote ((nil :maxlevel . 9)
;;                                 (org-agenda-files :maxlevel . 9))))
(setq org-agenda-files (quote ("~/Dropbox/OrgFiles/refile.org")))
(setq org-default-notes-file "~/Dropbox/OrgFiles/refile.org")
(setq diary-file "~/Dropbox/OrgFiles/diary.org")
(setq org-agenda-include-diary t)

(setq org-todo-keywords
      (quote ((sequence "TODO(t)" "NEXT(n!)" "WEEKLY-GOAL(w)" "|" "DONE(d!)")
              (sequence "WAITING(a@/!)" "HOLD(h@/!)" "|" "CANCELLED(c@/!)" "MEETING"))))
...
(setq org-todo-keyword-faces
      (quote (("TODO" :foreground "red" :weight bold)
	      ...
	      ("WEEKLY-GOAL" :foreground "cyan" :weight bold))))
...
(setq org-todo-state-tags-triggers
      (quote (("CANCELLED" ("CANCELLED" . t))
	      ...
	      ("WEEKLY-GOAL" ("WAITING")("CANCELLED") ("HOLD"))    
	 ...
	 ((agenda "")
	  (tags "REFILE"
		((org-agenda-skip-function '(org-agenda-skip-entry-if 'todo 'done))
		 (org-agenda-overriding-header "Tasks to be refiled")))
          (tags-todo "TODO=\"WEEKLY-GOAL\""
		((org-agenda-skip-function '(org-agenda-skip-entry-if 'todo 'done))
		 (org-agenda-overriding-header "Goals for the Week")))
	  (tags-todo "-CANCELLED/!"
	  ...
	  (tags-todo "-HOLD-CANCELLED/!"
		     ((org-agenda-overriding-header "Projects")
		      ...
		      (org-agenda-sorting-strategy
		       '(category-keep))))
	  (tags-todo "-CANCELLED+TODO=\"NEXT\"-TODO=\"WEEKLY-GOAL\""
	  ...
	  (tags-todo "-REFILE-CANCELLED-WAITING-HOLD-TODO=\"WEEKLY-GOAL\""
	   ...
	   (tags-todo "-REFILE-CANCELLED-WAITING-HOLD-TODO=\"WEEKLY-GOAL\""
                           ((org-agenda-overriding-header (concat "Standalone Tasks"
                            ...
                            (org-agenda-sorting-strategy
                             '(category-keep))))
                (tags-todo "-CANCELLED+WAITING|HOLD-TODO=\"WEEKLY-GOAL\""
...
(defun bh/skip-non-stuck-projects ()
  "Skip trees that are not stuck projects"
  (message "skip non stuck projects")
...
(defun bh/skip-project-trees-and-habits ()
  ...
  (message "skip project trees and habits")
  (save-restriction
    (widen)
    (let ((subtree-end (save-excursion (org-end-of-subtree t))))
      (cond
...
(defun bh/skip-projects-and-habits-and-single-tasks ()
  ...
  (message "skip projects and habits and single tasks")
  (save-restriction
    (widen)
    (let ((next-headline (save-excursion (or (outline-next-heading) (point-max)))))
      (cond
...
When not restricted, skip project and sub-project tasks, habits, and project related tasks."
  (message "skip project tasks maybe")
  (save-restriction
    (widen)
    (let* ((subtree-end (save-excursion (org-end-of-subtree t)))
...
Skip project and sub-project tasks, habits, and loose non-project tasks."
  (message "skip non project tasks")
  (save-restriction
    (widen)
    (let* ((subtree-end (save-excursion (org-end-of-subtree t)))
           (next-headline (save-excursion (or (outline-next-heading) (point-max)))))
...
(defun bh/skip-projects-and-habits ()
  ...
  (message "skip projects and habits")
  (save-restriction
    (widen)
    (let ((subtree-end (save-excursion (org-end-of-subtree t))))
      (cond
...
(defun bh/skip-non-archivable-tasks ()
  ...
  (message "skip non archivable tasks")
  (save-restriction
    (widen)
...
(defvar bh/organization-task-id "a36bf2aa-90fe-4ed1-b073-623cd29077ba")
...
(defun bh/mark-next-parent-tasks-todo ()
  ...
  (message "mark next parent tasks todo")
